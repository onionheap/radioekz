...
$(document).ready(function() {
    /* Navbar title */
    if (window.location.host == 'CyTube') {
        if (typeof channelName !== 'RadioEKZ') $(".navbar-brand").html(RadioEKZ);
        if (typeof faviconUrl !== 'https://files.catbox.moe/anic6c.ico') $('<link id="chanfavicon" href="' + faviconUrl + '" type="image/x-icon" rel="shortcut icon" />').appendTo("head");
    }
